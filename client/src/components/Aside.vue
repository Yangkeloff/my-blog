  ...
  <aside class="page_aside" v-click>
    <div class="layer">
      ...
      <div class="brief_box">
        ...
        <p class="brief_item">Yangkeloff</p>
        <p class="brief_item"><a href="mailto:yangkeloff@foxmail.com" :title='"电子邮箱\n1. yangkeloff@foxmail.com"' target="_blank">Email</a></p>
        <p class="brief_item"><a href="https://github.com/Yangkeloff" title="github搜索: Yangkeloff" target="_blank">GitHub</a></p>
      </div>
