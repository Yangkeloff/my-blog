<template>
  <div class="paginator">
    <ul>
      <li @click="jump(cur_page-1)"><Icon type="ios-arrow-back" size="24" /></li>
      <li v-for="i in pages" :key="i"
      :class="i==cur_page?'active':''"
      @click="jump(i)"><span>{{i}}</span></li>
      <li @click="jump(cur_page+1)"><Icon type="ios-arrow-forward" size="24"/></li>
